  ...
  componentDidMount() {
    ...
    axios
      ...
      .then((res) => {
        ...
        return axios.get(
          `https://arcane-springs-59786.herokuapp.com/https://api.musixmatch.com/ws/1.1/track.get?track_id=${this.props.match.params.id}&apikey=${process.env.REACT_APP_MM_KEY}`
        );
      })
      .then((res) => {
